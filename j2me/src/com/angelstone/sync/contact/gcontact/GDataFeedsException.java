...
public class GDataFeedsException extends GDataException {
	...
	public GDataFeedsException(String className, String methodName, Throwable cause) {
		this("Error at " + className + "." + methodName, cause);
	}

	public GDataFeedsException(Class sourceClass, String methodName, Throwable cause) {
		this("Error at " + sourceClass.getName() + "." + methodName, cause);
	}

	public GDataFeedsException(String message, String className, String methodName,
			Throwable cause) {
