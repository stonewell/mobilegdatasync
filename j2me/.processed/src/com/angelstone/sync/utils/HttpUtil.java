...
public class HttpUtil {
	...
	public static byte[] sendRequest(String url, String method,
			String postData, String authorization) throws IOException {
		return sendRequest(url, method, postData, authorization,
	...
	public static byte[] sendRequest(String url, String method,
		...
		try {
			...
			while (true) {
				...
				status = connection.getResponseCode(); // FIXME: blocks untill
														// finished or timeout
		...
		// if
		// (responseString.indexOf("Cannot access the calendar you requested")
		// != -1) {
