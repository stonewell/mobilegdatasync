...
public class AddFromSmsRecordView extends Activity implements OnItemClickListener,
															  OnClickListener															  
{
    ...
    protected void onCreate(Bundle savedInstanceState) 
	{
		try
		{
	        ...
	        while (!mCursor.isAfterLast())
	        {
	        	...
	        	String name = PhoneNumberManager.getIntance(this).getContactName(number);
	        ...
	        /*
	        mNumberColIndex = mCursor.getColumnIndex("address");
	        ListAdapter adapter= new SimpleCursorAdapter(this, 
	        		                                     R.layout.sms_record_list_row,
	        		                                     mCursor,
	        									         new String[] {"address", "body"},
	        									         new int[] {R.id.sms_record_number, R.id.sms_record_body});
	        */
	        ...
	        SimpleAdapter adapter= new SimpleAdapter(this, 
								                     mList,
												     R.layout.sms_record_list_row, 
												     new String[] {"number", "name", "body", "checkImg"},
												     new int[] {R.id.sms_record_number,
								                                R.id.sms_record_name, 
								                                R.id.sms_record_body,
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id)
	{
	    ...
	    intent.putExtra("sms_record_result", number); 
	    intent.putExtra("sms_record_result_name", name);
