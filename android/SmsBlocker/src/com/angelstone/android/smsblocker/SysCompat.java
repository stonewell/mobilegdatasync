...
public abstract class SysCompat {
	...
	public static Uri PHONE_URI = null;
	

	public static String COLUMN_CONTACT_NAME = null;
	public static String COLUMN_CONTACT_ID = null;
	
	public static String COLUMN_PHONE_NAME = null;
	public static String COLUMN_PHONE_NUMBER = null;	
	
	public static String COLUMN_PHONE_CONTACT_ID = null;
	public static String COLUMN_PHONE_ID = null;
	public static String PHONE_TYPE = null;
	public static String COLUMN_PHONE_TYPE = null;
	public static String COLUMN_PHONE_ID_v16 = null;
